...
# GGUFModelPatcher extracted from ComfyUI-GGUF/nodes.py.
# Removed: import nodes, import folder_paths, update_folder_names_and_paths() calls,
#           INPUT_TYPES/RETURN_TYPES/FUNCTION/CATEGORY node plumbing.
import collections
import logging
